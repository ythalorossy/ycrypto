package com.ythalorossy.crypto;
...
public class PgpEncryptionTest {
    ...
    private final URL privateKey = loadResource("/Ythalo_Saldanha_0xAB5B2085_SECRET.asc");
    private final URL publicKey = loadResource("/Ythalo_Saldanha_0xAB5B2085_public.asc");

    private final URL testFile = loadResource("/important-content.txt");
